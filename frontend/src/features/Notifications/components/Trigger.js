...
export default function Trigger({
  ...
  return (
    <button
      className={`inline-flex min-h-11 cursor-pointer items-center gap-2 rounded-xl border px-3.5 text-sm font-black shadow-xl backdrop-blur-xl transition-[background-color,border-color,color] duration-150 focus-visible:outline-2 focus-visible:outline-emerald-300 ${
        open

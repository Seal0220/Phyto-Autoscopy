export const PANEL_CLASS = "relative min-w-0 overflow-visible rounded-[28px] border border-white/10 bg-white/[0.07] shadow-[0_24px_80px_rgba(0,0,0,0.26),inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-2xl";
...
const TONE_STYLES = {
  ...
  neutral: "border-white/15 bg-black/20 text-white/80",
};
...
export function PanelHeader({ title, action }) {
  return (
    <div className="flex min-h-[68px] items-center gap-4 border-b border-white/10 bg-white/[0.04] px-5 py-4 max-sm:flex-wrap max-sm:px-4">
      <span className="size-2 shrink-0 rounded-full bg-emerald-300" aria-hidden="true" />

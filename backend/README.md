...
This directory is the API-only FastAPI hardware backend. It contains camera and motor control, experiment scheduling, settings, sessions, local storage, and the authenticated status WebSocket.
